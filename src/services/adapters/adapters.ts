...
import { PendingOffersForAdminDto, OfferDetailForAdminDto, BuySellDetailForAdminDto } from "src/services/dtos/adminDto";
import { AdminDetail, PublicationType } from "src2/types/admin-publications";
