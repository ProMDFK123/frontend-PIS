// src/views/app/students/your-publications/[id]/components/PublicationActionSection.tsx
        ...
        <aside className="space-y-6 sticky top-10">
            ...
            <section className="bg-slate-50 p-6 rounded-3xl border border-slate-100 space-y-4">
                ...
                {isPublished && isJobOffer && (
                    <Link href={`/students/your-publications/${detail.id}/applicants`} passHref>
