...
export default function Page() {
  ...
  function handleChange(
    ...
    // Nombre
    const nameError = validators.name(form.companyName, "Nombre de la empresa");
    if (nameError) errors.companyName = nameError;
  
    // Apellido
    const lastNameError = validators.name(form.legalName, "Razon social");
    if (lastNameError) errors.legalName = lastNameError;
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="col-span-1 border rounded-md px-6 py-8 flex flex-col items-center gap-4">
        ...
        {data?.profilePhoto ? (
          ...
          {data?.companyName ? data.companyName.charAt(0).toUpperCase() : "P"}
          </span>
        )}
        </div>
      ...
      <div className="col-span-1 md:col-span-2 border rounded-md p-6">
        ...
        <div>
          ...
          <>
            ...
            onChange={handleChange}
            className={fieldErrors.legalName ? "border-red-500" : ""}
            />
            {fieldErrors.legalName && (
            <p className="text-red-600 text-xs mt-1">{fieldErrors.legalName}</p>
            )}
          </>
          ) : (
          <div className="px-3 py-2 border rounded-md bg-gray-50">
