  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-indigo-700 via-purple-700 to-fuchsia-700 p-10">
      <div className="max-w-5xl mx-auto space-y-6">
        <h1 className="text-2xl font-bold text-white">Perfil — Administrador</h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Aquí van todos los campos de usuario */}
              {/* Ejemplo de un campo */}
              <ProfileField
  ...
  return (
    <div className={colSpan > 1 ? `md:col-span-${colSpan}` : ""}>
      ...
      {editing ? (
        textarea ? (
          <>
            <Textarea
              ...
              rows={6}
              maxLength={500}
              className={`resize-y min-h-32 ${fieldErrors[name] ? "border-red-500" : ""}`}
        ...
        <div className="px-3 py-2 border rounded-md bg-gray-50 min-h-[100px] whitespace-pre-wrap">
