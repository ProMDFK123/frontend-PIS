...
const SEED: Offer[] = [
  {
    ...
    deadline: "2025-09-20",
    postedAt: "2025-09-15",
    duration: "1 día (evento)",
    stipend: 55000,
  },
  {
    id: "2",
    title: "Diseño flyer (freelance)",
    type: "Trabajo",
    image: "/generic.png",
    deadline: "2025-09-25",
    postedAt: "2025-09-16",
    duration: "Entrega única",
    stipend: 40000,
  },
  {
    id: "3",
    title: "Venta de libros usados Cálculo I",
    type: "CompraVenta",
    image: "/generic.png",
    deadline: "2025-10-05",
    postedAt: "2025-09-14",
    duration: "Producto único",
    stipend: 12000,
  },
  {
    id: "4",
    title: "Clases de inglés (B1 → B2)",
    type: "Trabajo",
    image: "/generic.png",
    deadline: "2025-10-01",
    postedAt: "2025-09-17",
    duration: "2 meses (2h/sem)",
    stipend: 0,
  },
];
  ...
  const filtered = useMemo(() => {
    ...
    switch (sort) {
      case "fecha":
        ...
        break;
      case "monto":
        // ✅ precio MÁS BAJO primero (ascendente)
